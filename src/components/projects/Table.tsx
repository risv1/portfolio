					...
					const RowContent = (
						...
						>
							<div className="flex gap-12 md:gap-24 items-center">
								<div
									className={`w-32 text-white/60 ${!isUpcoming && "group-hover:text-white"} transition-colors duration-300`}
								>
									{project.purpose}
								</div>
								<div>
							...
							<div className="flex gap-12 md:gap-24 items-center text-right">
								<div
									className={`text-white/60 ${!isUpcoming && "group-hover:text-white"} transition-colors duration-300`}
								>
									{project.industry}
								</div>
								<div
									className={`w-20 text-white/60 ${!isUpcoming && "group-hover:text-white"} transition-colors duration-300`}
								>
									{project.year}
								</div>
							</div>
