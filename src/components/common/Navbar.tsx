...
const Navbar: React.FC = () => {
    ...
    return (
        <>
            <nav className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-md w-full">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-row justify-between items-center h-16">
                        <div className="flex items-center lg:gap-40 md:gap-24 gap-16">
                            <Link
                                to="/"
                                className={`font-medium text-lg hover:opacity-80 transition-all relative z-[60] ${
                            ...
                            <span
                                className={`text-sm md:text-md relative z-[60] ${
                                    isPanelOpen ? "text-black" : "text-white"
                                }`}
                            >
                                {currentTime}
                        ...
                        <div className="flex items-center gap-10">
                            <a
                                href="https://drive.google.com/file/d/1AYw3llVEXJfNEUevgXVKO5F-JBXYsloi/view?usp=sharing"
                                target="_blank"
                            ...
                            <button
                                ...
                                className={`lg:hidden flex flex-col gap-1.5 w-8 h-8 justify-center items-center transition-colors relative z-[60] ${
                                    isPanelOpen ? "opacity-0 pointer-events-none" : "text-white"
                                }`}
                                aria-label="Menu"
                            >
            ...
            <div
                className={`fixed inset-0 w-full h-full bg-white z-[100] transition-transform duration-500 ease-in-out ${
                ...
                <div className="flex flex-col h-full p-8 overflow-y-auto">
                    <div className="flex justify-end mb-16">
                        <button
                            ...
                            className="text-black text-sm font-medium hover:opacity-70 transition-opacity z-[110]"
                        >
                            Close ✕
                        </button>
                    </div>
