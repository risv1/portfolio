...
const Featured: React.FC = () => {
    ...
    return (
        <section ref={containerRef} className="relative min-h-screen bg-black py-20 px-4 md:px-16 lg:px-24 overflow-x-hidden">
                                ...
                                >
                                    <div className="absolute inset-0 bg-neutral-900">
                                        {project.gallery && project.gallery.length > 0 && (
                                            <>
                                                <img
                                                    src={hoveredProject === project.slug && project.productGif 
                                                        ? project.productGif 
                                                        : project.gallery[0]}
                                                    alt={project.name}
