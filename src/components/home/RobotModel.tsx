...
export function RobotModel() {
    ...
    useEffect(() => {
        ...
        scene.traverse((child) => {
            if (child instanceof THREE.Bone && child.name.includes('Arm')) {
