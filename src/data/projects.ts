...
export const allProjects: (ProjectData & { status: 'completed' | 'upcoming' })[] = [
    // 2025 Projects
    {
        name: "MW Scraper",
        purpose: "Internship",
...
export const projectDetails: Record<string, ProjectDetail> = {
    ...
    "mamba-nlp": {
        ...
        slug: "mamba-nlp",
        title: "Mamba PyTorch",
        introDescription: "This repository contains a basic PyTorch implementation of the Mamba model for NLP.",
        link: "https://github.com/yourusername/mamba-nlp",
        productDescription: "Mamba PyTorch is an educational implementation of the Mamba architecture for natural language processing tasks. This project provides a clean, well-documented PyTorch implementation that demonstrates the core concepts of the Mamba model, making it accessible for researchers and students interested in understanding modern NLP architectures. The implementation includes training scripts, model architecture details, and example use cases for various NLP tasks.",
    ...
    "codebin": {
        ...
        slug: "codebin",
        title: "Codebin",
        introDescription: "Codebin is a platform that allows users to share code snippets, similar to Pastebin, but with a focus on code sharing and collaboration.",
        link: "https://github.com/yourusername/codebin",
        productDescription: "Codebin is a modern code-sharing platform that enables developers to quickly share, collaborate on, and discuss code snippets. Built with Nuxt.js for a fast, SEO-friendly frontend and PostgreSQL for reliable data storage, the platform offers syntax highlighting for multiple programming languages, version control for snippets, and collaborative editing features. Deployed on AWS, Codebin provides a seamless experience for developers to share knowledge and solve problems together.",
