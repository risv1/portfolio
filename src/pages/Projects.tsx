...
const Projects: React.FC = () => {
	...
	return (
		<Default>
			<div className="min-h-screen w-full bg-black pt-32 pb-20 px-6 md:px-12 lg:px-24">
								...
								{isFilterOpen && (
									<>
										...
										<motion.div
											...
											className="absolute right-0 top-full mt-4 w-64 bg-neutral-900 border border-white/10 rounded-xl p-6 shadow-2xl z-50"
										>
											<div className="space-y-6">
												...
												{(industryFilter || purposeFilter) && (
													<button
														...
														className="w-full text-xs text-center text-white/40 hover:text-white transition-colors pt-2 border-t border-white/10"
													>
														Clear Filters
													</button>
												)}
