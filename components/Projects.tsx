...
export default function Projects() {
    ...
    const projects = [
        ...
        {name: "SnapSave", description: "This application deals with purchasing tickets to, and managing, events, built with Remix.js and Go Fiber.", url: "https://github.com/risv1/SnapSave"},
    ]

  return (
    <div id="projects" className="w-full h-full flex xl:px-40 lg:px-40 px-10 py-20 flex-col gap-10">
